...
NVIDIA_API_KEY = os.getenv("NVIDIA_API_KEY", "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")
...
def generate(prompt, schema=None):
    ...
    if response.status_code == 200:
        ...
        print(f"Lỗi gọi API NVIDIA: {response.text}")
        return ""
